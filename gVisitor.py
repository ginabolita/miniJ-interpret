...
class gVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by gParser#unariExpr.
    def visitUnariExpr(self, ctx:gParser.UnariExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by gParser#binariExpr.
    def visitBinariExpr(self, ctx:gParser.BinariExprContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by gParser#callFunc.
    def visitCallFunc(self, ctx:gParser.CallFuncContext):
        return self.visitChildren(ctx)
